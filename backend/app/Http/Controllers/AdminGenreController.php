...
class AdminGenreController extends Controller
{
    ...
    public function store(StoreAdminGenreRequest $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => ['id' => $genre->id, 'name' => $genre->nome, 'category' => $genre->categoria ?? '', 'active' => true],
        ], 201);
    }
    ...
    public function update(UpdateAdminGenreRequest $request, Genre $genre): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => ['id' => $genre->id, 'name' => $genre->nome, 'category' => $genre->categoria ?? '', 'active' => (bool) $genre->ativo],
        ]);
    }
