      ...
      <section className="space-y-2">
        ...
        {posts.map((post) => {
          ...
          return (
            <article
              key={post.id}
              className="rounded-lg border border-line/30 bg-white p-3 sm:p-4"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h2 className="mt-1 text-base font-semibold leading-tight text-ink">
                    {post.titulo}
                  </h2>
              ...
              {post.imagem_url ? (
                <div className="mt-3 overflow-hidden rounded-md border border-line/25 bg-white">
                  <img
                    src={post.imagem_url}
              ...
              {linkedBook ? (
                <Link
                  ...
                  className="mt-3 flex gap-2 rounded-md border border-line/30 bg-[#fbfaf7] p-2.5 transition-colors hover:border-accent/35"
                >
                  <div className="min-w-0">
                    <p className="inline-flex items-center gap-1 text-[11px] font-semibold uppercase tracking-wide text-ink-muted">
                      Livro vinculado
                    </p>
              ...
              <div className="mt-3 flex items-center gap-2 border-t border-line/25 pt-2.5 text-xs text-ink-muted">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex h-8 items-center gap-1.5 rounded-md border border-line/35 bg-white px-2.5 text-xs font-semibold text-ink-dim transition-colors hover:border-accent/35 hover:text-brand-deep"
                >
              ...
              {isCommentsOpen[post.id] ? (
                <section className="mt-3 space-y-2 border-t border-line/25 pt-3">
                  <div className="space-y-2">
                    {(
                      ...
                      <article
                        key={comment.id}
                        className="rounded-md border border-line/30 bg-[#fbfaf7] px-2.5 py-2"
                      >
